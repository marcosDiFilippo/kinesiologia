                ...
                <?php
                    if ($esAdmin == true) {
                        ...
                        echo "<a href='informacion-general.php' class='col-6 d-flex flex-column justify-content-center align-items-center'>
                            ...
                            <span class='span-index'>Ver informacion general</span>
                        </a>";
                    }
                ?>
                <a href="pacientes.php" class="col-6 d-flex flex-column justify-content-center align-items-center">
                    <svg class="svg-2" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-user"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /></svg>
                    <span class="span-index">Pacientes</span>
                </a>
            </article>
            <article class="row article-links-2">
                <a href="sesiones.php" class="col-6 d-flex flex-column justify-content-center align-items-center">
                ...
                <a href="tratamientos.php" class="col-6 d-flex flex-column justify-content-center align-items-center">
